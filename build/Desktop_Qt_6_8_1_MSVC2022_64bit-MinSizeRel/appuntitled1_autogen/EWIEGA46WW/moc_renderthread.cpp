...
static constexpr auto qt_meta_stringdata_ZN12RenderThreadE = QtMocHelpers::stringData(
    "RenderThread"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12RenderThreadE[] = {
...
Q_CONSTINIT const QMetaObject RenderThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12RenderThreadE.offsetsAndSizes,
    qt_meta_data_ZN12RenderThreadE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12RenderThreadE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<RenderThread, std::true_type>
    >,
    nullptr
} };
...
void *RenderThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12RenderThreadE.stringdata0))
